...
\end{align*}
```
Due to the implementation of the model in the program, the state was assumed and using the built-in inv_logit function ( $\text{inv\_logit}(u)=\frac{1}{1+e^{-u}}$), it was assumed that:
